...
* [Computational Pipeline](#computational-pipeline)
  ...
  * (3) [Read quality control](#3-read-quality-control)
  * (4) [Read mapping](#4-read-mapping)
  * (5) [Peak calling](#5-peak-calling)
  * (6) [Motif discovery](#6-motif-discovery)
  * (7) [Replicate quality control and merging](#7-replicate-quality-control)
  * (8) [Representative motif selection](#8-representative-motif-selection)
* [Software and Data Versions Used](#software-and-data-versions-used)
